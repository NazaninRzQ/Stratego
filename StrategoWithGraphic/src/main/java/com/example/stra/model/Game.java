...
public class Game {
    ...
    public void run(){
        ...
        while(true){
            if(current == gamer){
                System.out.println("Enter index of your piece and your move (example : 1,2,u) : ");
    ...
    public boolean move_gamer(int i,int j,int nextI,int nextJ){
        if(board[nextI][nextJ] != null){
            ...
            if(t2.toString().equals("OP")){
                ...
                printBoard();
                System.out.println("**Erorre** can not move Here , try again.............");
                current=gamer;
            }
        }
        else{
            if(!isRiver(nextI, nextJ)){
                ...
                System.out.println("**Erorre** Here is River, try again..........");
                current=gamer;
            }
        }
